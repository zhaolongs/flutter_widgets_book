...
//     Expanded(child: Container(child:Column(crossAxisAlignment: CrossAxisAlignment.start,children: bluldLeftWidget2(context),),),)
  ...
  bluldLeftWidget(BuildContext context){
    return [
      ...
      buildContainerAndClick("文本标签",(){NavigatorUtils.pushPage(context, TextTagPage());}),

      buildContainerAndClick("文本标签与流式布局",(){NavigatorUtils.pushPage(context, TextWarpTagPage());}),
    buildContainerAndClick("富文本RichText使用案例",(){NavigatorUtils.pushPage(context, RichTextTagPage());}),
